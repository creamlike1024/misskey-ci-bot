...
func init() {
    ...
    CommandsInstance = Commands{
        ...
        DbReindex:  fmt.Sprintf("docker compose -f %s exec db psql -U %s -c 'REINDEX DATABASE %s;'", DeployConfigInstance.DockerComposeFile, DeployConfigInstance.DbUser, DeployConfigInstance.DbName),
